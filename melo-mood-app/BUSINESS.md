...
> 定位：個人化神經適應引導（Personalized Neuro-adaptive Guidance）與情緒健康輔助系統。
...
| **痛點** | 市面顯化 App 是固定模板音檔，聽三天就膩；別人的聲音對潛意識說服力有限 |
| **解法** | AI 讀你的目標 + 日記，動態寫腳本；用你錄的 30 秒聲音複製，**由你唸給你聽** |
...
| **留存？** | 三個 Hook：每日心情打卡（3 秒）→ 感恩日記（90 秒）→ 睡前導引（12 分鐘，習慣錨定在床上）。目標 D30 留存 ≥ 25%（Calm 約 20%） |
...
| 方案 | 月費（NT$） | 內容 | 目的 |
|---|---|---|---|
| **Free** | 0 | 1 目標、每日一段 3 分鐘腳本、系統聲音、日記 | 養習慣、收資料 |
| **Glow** ⭐ | 290（年繳 2,490） | 無限腳本、3 語氣、**聲音複製**、睡前催眠、環境音、30 天洞察 | 主力營收 |
...
| **休息 1 週** | — | — |
| **Sprint 2（3 週）** | Claude 腳本引擎 + 日記閉環 + TapPay 訂閱 | 第一位付費用戶 |
